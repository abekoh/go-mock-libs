...
func (m *MockRepository) GetAll(ctx context.Context, userId uuid.UUID) (examination.ExaminationList, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetAll", ctx, userId)
	ret0, _ := ret[0].(examination.ExaminationList)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (m *MockRepository) Save(ctx context.Context, exam examination.Examination) error {
	m.ctrl.T.Helper()
